      ...
      {/* <Container> */}
        <div className="about__container">
          <div className="about__content">
            <div className="about__head-image">
              <img
                src="https://wirengimages.s3.amazonaws.com/images/homeimages/YATCH-IMAGE.jpg"
                alt="WirEng® about image"
              />
            </div>

            <div className="about__flex-container">
              <div className="about__header mt-5">
                <h1 style={{ color: '#004987'}}>About WirEng®</h1>
              ...
              <div className="about__antenna-image">
                <img
                  src="https://wirengimages.s3.amazonaws.com/images/homeimages/Group+63Antenna.jpg"
                  alt="about image antenna"
                />
              </div>
            </div>
          </div>
